...
if __name__ == "__main__":
    ...
    ranges = {
        ...
        "delay_ms_b_up": {"range": [1000.0, 1000.0], "type": float, "count": 1},  # ms
        "delay_ms_b_down": {"range": [10.0, 10.0], "type": float, "count": 1},  # ms
    }
    ...
    run_experimental_design(test_nets_opts, ranges, run_multipath_xp,
                            db_filename='results_mptcp_asym_specific.db',
